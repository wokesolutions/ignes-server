...
public class DistrictCode {
	...
	public static final String BRAGANÇA = "Bragança";
	public static final String CASTELO_BRANCO = "Castelo Branco";
	public static final String COIMBRA = "Coimbra";
	public static final String EVORA = "Évora";
	public static final String FARO = "Faro";
	public static final String GUARDA = "Guarda";
	public static final String LEIRIA = "Leiria";
	public static final String LISBOA = "Lisboa";
	public static final String PORTALEGRE = "Portalegre";
	public static final String PORTO = "Porto";
	public static final String SANTAREM = "Santarém";
	public static final String SETUBAL = "Setúbal";
	public static final String VIANA_DO_CASTELO = "Viana do Castelo";
	public static final String VILA_REAL = "Vila Real";
